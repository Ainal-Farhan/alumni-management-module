        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2"><input type="text" name="updatedEmployerAddress1" class="form-control<%= styleInput %>" id="alumniAddress1" value="<% out.print(request.getAttribute("employerAddress1")); %>" <%= readOnly %>></td>
                </tr>
                <tr>
                    <th><label>Address Line 2</label></th>
                    <td colspan="2"><input type="text" name="updatedEmployerAddress2" class="form-control<%= styleInput %>" id="alumniAddress2" value="<% out.print(request.getAttribute("employerAddress2")); %>" <%= readOnly %>></td>
                </tr>
                <tr>
                    <th><label>City</label></th>
                    <td colspan="2"><input type="text" name="updatedEmployerAddressCity" class="form-control<%= styleInput %>" id="alumniAddressCity" value="<% out.print(request.getAttribute("employerAddressCity")); %>" <%= readOnly %>></td>
                </tr>
                <tr>
                    <th><label>Post Code</label></th>
                    <td colspan="2"><input type="text" name="updatedEmployerAddressPostCode" maxlength="5" class="form-control<%= styleInput %>" id="alumniAddressPostCode" value="<% out.print(request.getAttribute("employerAddressPostCode")); %>" <%= readOnly %>></td>
                </tr>
                <tr>
                    <th><label>State</label></th>
                    <td colspan="2"><input type="text" name="updatedEmployerAddressState" class="form-control<%= styleInput %>" id="alumniAddressState" value="<% out.print(request.getAttribute("employerAddressState")); %>" <%= readOnly %>></td>
                </tr>
                <tr>
                    <th><label>Country</label></th>
                    <td colspan="2"><input type="text" name="updatedEmployerAddressCountry" class="form-control<%= styleInput %>" id="alumniAddressCountry" value="<% out.print(request.getAttribute("employerAddressCountry")); %>" <%= readOnly %>></td>
                </tr>
            </tbody>
        </table>
                
        <script>
            setInputFilter(document.getElementById("updatedEmployerAddressPostCode"), function(value) {
